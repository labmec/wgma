  ...
  */
  ...
  public:
    ...
    */
     ...
     */
    virtual void PostProcess(std::string filename, const int vtk_res = 0, const bool print_real_part=true) = 0;
  ...
  public:
    ...
    */
    ...
    /**
       ...
       @param[in] print_real_part whether to print the real part (or magnitude) of the field
     */
    void PostProcess(std::string filename, const int vtk_res = 0, const bool print_real_part=true) override;
