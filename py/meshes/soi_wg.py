...
def create_arrow_mesh(w_rib_in_1, w_rib_in_2, w_rib_in_3,
    ...
    pml_port_in = FindPML2D(
        pmlmap, air_port_in+sub_port_in+ag5_left_port_in+ag5_right_port_in)
    pmlmap2d.update(pml_port_in)
    pml_probe_in = FindPML2D(
        pmlmap, air_probe_in + sub_probe_in + ag5_left_probe_in +
        ag5_right_probe_in)
    pmlmap2d.update(pml_probe_in)
    pml_port_out = FindPML2D(
        pmlmap, air_port_out + sub_port_out + ag5_left_port_out +
        ag5_right_port_out)
    pmlmap2d.update(pml_port_out)
    pml_probe_out = FindPML2D(
        pmlmap, air_probe_out + sub_probe_out + ag5_left_probe_out +
        ag5_right_probe_out)
